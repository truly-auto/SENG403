...
INSERT INTO ORDER_HISTORY (ORDER_NUMBER, SUPPLIER_ID, TOTAL_COST, TIME_DATE_CREATED, STATUS, SUPERMARKET_ID)
VALUES (123456, 1, 500.50, CURRENT_TIMESTAMP, "submitted",1);

INSERT INTO ORDER_HISTORY (ORDER_NUMBER, SUPPLIER_ID, TOTAL_COST, TIME_DATE_CREATED, STATUS, SUPERMARKET_ID)
VALUES (123123, 2, 156000.99, CURRENT_TIMESTAMP, "shipped",2);

INSERT INTO ORDER_HISTORY (ORDER_NUMBER, SUPPLIER_ID, TOTAL_COST, TIME_DATE_CREATED, STATUS, SUPERMARKET_ID)
VALUES (121212, 1, 10600.49, CURRENT_TIMESTAMP, "completed",1);
