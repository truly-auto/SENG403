...
INSERT INTO ORDER_HISTORY (SUPPLIER, TOTAL_COST, DATE_TIME_CREATED, STATUS, STORE_ID)
VALUES ('Someone', 500.50, CURRENT_TIMESTAMP, 'submitted',1);

INSERT INTO ORDER_HISTORY (SUPPLIER, TOTAL_COST, DATE_TIME_CREATED, STATUS, STORE_ID)
VALUES ('AHAHAHA', 156000.99, CURRENT_TIMESTAMP, 'shipped',2);

INSERT INTO ORDER_HISTORY (SUPPLIER, TOTAL_COST, DATE_TIME_CREATED, STATUS, STORE_ID)
VALUES ('Idunnoyet', 10600.49, CURRENT_TIMESTAMP, 'completed',1);
