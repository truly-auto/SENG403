...
public class AddUser extends JDialog {
	...
	/**
	 * Initialize the contents of adding a new user. Input a new username, and
	 * set the user as a manager or not. Will not allow you to create new user
	 * if the username is taken
	 * 
	 * @param id
	 *            , the id of the supermarket or supplier to add a new user to.
	 */
	private void initialize(final int id) {
		...
		btnCheckAvailability.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (!textField.getText().equals("")) {
					// call method to return boolean corresponding to validity
					// of user name
		...
		btnAddUser.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				// call method to return boolean corresponding to validity of
				// user name, in case user didn't check for validity
				validUsername(textField.getText());
